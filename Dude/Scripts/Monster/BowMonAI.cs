...
public class BowMonAI : MonoBehaviour
{
    public enum State
    {
        IDLE,
    ...
    GameObject canvasEffect;//피통 없애기 0610
    ...
    void Fire()
    {
        ...
        {
            GameObject _MagicArrow = Instantiate(MagicArrow, firePos.position, firePos.rotation);
            Destroy(_MagicArrow, 2f);
        }
        else
        {
            GameObject _magicBall = Instantiate(magicBall, firePos.position, firePos.rotation);
